...
<head>
    ...
    <nav class="navbar navbar-ex[and-md navbar-light bg-white shadow-sm">
        <div class="container">
                ...
                @guest
                    ...
                    @else
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item" href="{{route('logout') }}"onclick="event.preventDefault();document.getElementById('logout-fom').submit();">{{ ('Logout') }} </a>
